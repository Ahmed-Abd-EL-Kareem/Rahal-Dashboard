...
export class PlaceholderComponent {
  ...
  onCardClick(card: KPICard): void {
    if (card.label === 'Total Trips' || card.label === 'Active Packages' || card.label === 'Trips Generated by AI') {
  ...
  pageInfo = computed(() => {
    ...
    return {
      ...
      kpis: [
        ...
        { label: 'Total Trips', value: '8.9K', delta: '+12.4%', positive: true, icon: 'matTravelExploreOutline', iconBg: 'bg-indigo-500/10', iconColor: 'text-indigo-600' }
      ] as KPICard[],
      activities: [
